    ...
    public String getDiscussPost(@PathVariable("discussPostId") int discussPostId, Model model, Page page) {
        ...
        if (commentList != null) {
            for (Comment comment : commentList) {
                ...
                // 点赞数量
                likeCount = likeService.findEntityLikeKey(ENTITY_TYPE_COMMENT, comment.getId());
                ...
                if (replyList != null) {
                    for (Comment reply : replyList) {
                        ...
                        // 点赞数量
                        likeCount = likeService.findEntityLikeKey(ENTITY_TYPE_COMMENT, reply.getId());
